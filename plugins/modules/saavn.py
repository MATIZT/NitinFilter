...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton('ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋs', url='https://t.me/MoviesFlicker/2')]])
...
ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴊᴏɪɴ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ <a href='http://t.me/MoviesFlickerGroup'>ᴄʟɪᴄᴋ</a>
...
#   album_id = r.json()[0]["albumid"]
    ...
    buttons = [[
        InlineKeyboardButton("ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴊᴏɪɴ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ", url="https://t.me/MoviesFlickerGroup")
    ]]                           
    await message.reply_video(
    video=ffile, caption=f"[{sname}]({r['data']['results'][0]['url']}) - from @Matiz_Techz ",thumb=thumbnail,
...
async def r_message(client, message):
    ...
    buttons = [[
        InlineKeyboardButton('𝐉𝐨𝐢𝐧 𝐆𝐫𝐨𝐮𝐩', url=f'http://t.me/MoviesFlickerGroup')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
